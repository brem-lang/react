...
import FaPdf from "../../components/PDF/faPdf";
...
function FASlipList() {
  ...
  useEffect(() => {
    const getMiSlipList = async () => {
      if (miSlipData?.faState === false) return;
      ...
      try {
        const res = await axios.get("/api/get/wsfa", config);
        dispatch(
          miListData({ ...miSlipData, faList: res.data.data, faState: false })
        );
      } catch (err) {
        ...
        <div className="container-fluid">
          <div className="row mb-2">
            <div className="col-sm-6">
              <h1 className="m-0">FA Slip List</h1>
            </div>
            {/* /.col */}
            <div className="col-sm-6">
              <ol className="breadcrumb float-sm-right">
                ...
                <li className="breadcrumb-item active">FA Slip List</li>
              </ol>
            </div>
            {/* /.col */}
          </div>
                ...
                <div className="card">
                  <div className="card-header">
                    <div className="card-tools">
                      <Link to="/fa-slip" className="btn btn-success">
                        Add Slip
                      </Link>
                    </div>
                  </div>
