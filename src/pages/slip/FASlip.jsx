  ...
  const onSubmit = async (data) => {
    ...
    try {
      ...
      if (res.data.success === true) {
        dispatch(miListData({ ...slipList, faState: true }));
                      ...
                      <div className="row">
                        ...
                        <div className="col-6">
                          <div className="form-floating mb-3">
                            ...
                            style={{ border: errors.mr_no ? '1px solid red' : '' }}
                            />
                    ...
                    {fields.map((items, index) => {
                      return (
                        <div className="row" key={items.id}>
                          ...
                          <div className="col">
                            <div className="form-floating mb-3">
                              <input {...register(`items.${index}.qty`,{required:true})} type="number" 
                          ...
                          <div className="col">
                            <div className="form-floating mb-3">
                              ...
                              style={{ border: errors?.items?.[index]?.serial_no ? '1px solid red' : '' }}
                              />
                               {errors?.items?.[index]?.serial_no && <p>Serial is required</p>}
                            </div>
                          </div>
                          <div className="col">
                            <div className="form-floating mb-3">
