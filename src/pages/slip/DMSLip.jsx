                  ...
                  <form onSubmit={handleSubmit(onSubmit)}>
                    ...
                    <div className="card-body">                           
                      <div className="row">
                        <div className="col">
                          <div className="form-floating mb-3">
                            <input type="text" {...register("purpose", { required: "Purpose is required" })} 
                            className="form-control" placeholder="Purpose" autoComplete="off" 
                            style={{ border: errors.purpose ? '1px solid red' : '' }}
                            />
                        ...
                        <div className="col">
                          <div className="form-floating mb-3">
                            ...
                            type="text"  className="form-control" placeholder="Customer Name" autoComplete="off" 
                      ...
                      <div className="row">                   
                        <div className="col">
                          <div className="form-floating mb-3">
                            <input {...register("order_no", { required: "Order Number is required" })} type="number" 
                             ...
                             style={{ border: errors.order_no ? '1px solid red' : '' }}
                             />
                        ...
                        <div className="col-6">
                          <div className="form-floating mb-3">
                            <input {...register("product_name", { required: "Product Name is required" })} type="text"  
                            className="form-control" placeholder="Product Name" autoComplete="off" 
                            style={{ border: errors.product_name ? '1px solid red' : '' }}
                            />
                        ...
                        <div className="row" key={items.id}>
                          ...
                          <div className="col">
                            <div className="form-floating mb-3">
                              ...
                              />
                                {errors?.items?.[index]?.item_description && <p>Item Description is Required</p>}
                            </div>
                          </div>
                          <div className="col">
                            <div className="form-floating mb-3">
