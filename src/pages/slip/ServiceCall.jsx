                ...
                <form onSubmit={handleSubmit(onSubmit)}>
                  ...
                  <div className="card-body">
                    <div className="row">
                        ...
                        <div className="col">
                            <div className="form-floating mb-3">
                                <input type="number"  {...register("contact_number", { required: "Contact Number is required" })}  
                                 ...
                                 style={{ border: errors.contact_number ? '1px solid red' : '' }}
                                 />
                        ...
                        <div className="col">
                            <div className="form-floating mb-3">
                                <input type="number"  {...register("phone_no", { required: "Phone Number is required" })} 
                                  className="form-control" placeholder="Phone number" autoComplete="off"
                                  style={{ border: errors.phone_no ? '1px solid red' : '' }}
                                  />
                        ...
                        <div className="col">
                            <div className="form-floating mb-3">
                                <input type="text"  {...register("item_no", { required: "Item Number is required" })}   
                                 ...
                                 style={{ border: errors.item_no ? '1px solid red' : '' }}
                                 />
                        ...
                        <div className="col">
                            <div className="form-floating mb-3">
                                <input type="text"{...register("mfr_serial_no", { required: "MFR Serial Number is required" })} 
                                  ...
                                  style={{ border: errors.mfr_serial_no ? '1px solid red' : '' }}
                                  />
                        ...
                        <div className="col">
                            <div className="form-floating mb-3">
                                <input type="text"  {...register("serial_no", { required: "Serial Number is required" })}  
                                 ...
                                 style={{ border: errors.serial_no ? '1px solid red' : '' }}
                                 />
                    ...
                    <div className="row">
                        ...
                        <div className="col">
                            <div className="form-floating mb-3">
                                <input type="text"  {...register("origin", { required: "Origin is required" })}
                                 ...
                                 style={{ border: errors.origin ? '1px solid red' : '' }}
                                 />
                        ...
                        <div className="col">
                            <div className="form-floating mb-3">
                                ...
                                style={{ border: errors.problem_type ? '1px solid red' : '' }}
                                />
                        ...
                        <div className="col">
                            <div className="form-floating mb-3">
                                ...
                                style={{ border: errors.assigned_to ? '1px solid red' : '' }}
                                />
                    ...
                    <div className="row">
                        ...
                        <div className="col">
                            <div className="form-floating mb-3">
                                ...
                                style={{ border: errors.call_type ? '1px solid red' : '' }}
                                />
                        ...
                        <div className="col">
                            <div className="form-floating mb-3">
                                ...
                                style={{ border: errors.technician ? '1px solid red' : '' }}
                                />
                        ...
                        <div className="col">
                            <div className="form-floating mb-3">
                                <input  type="text" {...register("remarks", { required: "Remarks is required" })} 
                                 ...
                                 style={{ border: errors.remarks ? '1px solid red' : '' }}
                                 />
